...
# -------------------------- T0: 元信息 (Meta Info) --------------------------
# 新名称：41_融资融券交易汇总.py
SCRIPT_NAME = "41_融资融券交易汇总"
INTERFACE_NAME = "margin" # 接口：margin
PARTITION_KEY = 'trade_date' 
# 新目录：D:\2025\raw\股票数据\两融及转融通\融资融券交易汇总\
OUTPUT_BASE_SUBDIR = os.path.join('股票数据', '两融及转融通', '融资融券交易汇总') 
OUTPUT_FORMAT = 'csv' 
...
MAX_RETRY = 3 
# margin 接口限制 5000次/分钟。设置为 0.35 秒的安全间隔。
